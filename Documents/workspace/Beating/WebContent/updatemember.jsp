...
<table class="tg" align=center>
 <tr>
  ...
  <tr>
	...
	if(stat.equals("updateok")){
		out.println("수정이 완료되었습니다.");
	}
	if(stat.equals("updatefalse")){
		out.println("수정 에러가 발생했습니다.");
	}
%>
	...
	<table border="0" align="center">
		<tr>
			<td>
				<img src="https://i.imgur.com/5Zi5pGH.png" height="30px"  />			</td>
			<td>
				<%=id%>
			</td>
		</tr>
		<tr>
			<td>
				<img src="https://i.imgur.com/g3ot1Ou.png"height="30px"   />		</td>
			<td>
		...
		<tr>
			<td>
				<img src="https://i.imgur.com/V8vOQE5.png" height="30px"  /> 
			</td>
			<td>
				<input type="text"  style="text-align:center; width:200px; height:40px;" name="_name" value=<%=name%>>
			</td>
		</tr>
		<tr>
			<td>
				<img src="https://i.imgur.com/14GAgdT.png" height="30px"  />			</td>
			<td>
		...
		<tr>
			<td>
				<img src="https://i.imgur.com/fBI9v52.png"height="30px"   />
			</td>
			<td>
...
<tr><td>
<input type="image" name="submit" src="https://i.imgur.com/R5ENSFk.png"  height="50px"/>
</tr></td>	</table>
