...
<table class="tg" align=center>
 <tr>
    ...
    <th class="tg-yw4l"><%=session.getAttribute("memberName") %><img src="https://i.imgur.com/1RL5Zlb.png"  /></th>
  </tr>
  <tr>
  ...
  <tr>
	...
	<form action="logout.do" method="post">
		<input type="image" name="submit" src="https://i.imgur.com/D9BgHrO.png"  />
	</form>
	<form action="updatemember.do" method="get">
		<input type="image" name="submit" src="https://i.imgur.com/R5ENSFk.png"  />
	</form>
