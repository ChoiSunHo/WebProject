...
<%
	...
	if(meetingID==0){
		...
		if(request.getParameter("meetingTitle") == null || request.getParameter("meetingContent") == null
				||request.getParameter("meetingTitle").equals("")||request.getParameter("meetingContent").equals("")){
			PrintWriter script = response.getWriter();
			script.println("<script>");
			...
			int result = meetingDAO.update(meetingID,request.getParameter("meetingTitle")
					,request.getParameter("meetingContent"));
			if(result == -1){
				PrintWriter script = response.getWriter();
				script.println("<script>");
